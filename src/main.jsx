...
function App() {
  ...
  return <div className="app-shell">
    <aside className="sidebar">
      ...
      <div className="profile-mini"><div className="avatar">김</div><div><strong>김하늘</strong><span>꾸준히, 나답게</span></div><ChevronDown size={15} /></div>
      <nav>
